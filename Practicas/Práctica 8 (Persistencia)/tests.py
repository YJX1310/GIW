...
PRODUCTOS_INCORRECTOS = [
            Producto(codigo_barras="1234567895412", nombre=32, categoria_principal=5,
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre=True, categoria_principal=5,
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="a", categoria_principal=5,
                     categorias_secundarias=[5, 8, 9]),
            ...
            Producto(codigo_barras="4006381333930", nombre="Galletas", categoria_principal=5,
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categoria_principal="alimentos",
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categoria_principal=False,
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categoria_principal=-5,
                     categorias_secundarias=[-5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categoria_principal=3.14,
                     categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categorias_secundarias=[5, 8, 9]),
            Producto(codigo_barras="1234567895412", nombre="Galletas Oreo", categoria_principal=5,
